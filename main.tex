...
\begin{defn} We define the interior and closure:
    ...
    \end{enumerate}
\end{defn}
The closure of the set relies on arbitrary intersections which is possible due to the arbitrary intersections of closed set collections in the topology.
