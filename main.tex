...
\end{defn}
If $A \subseteq X$, then we can write $\partial A$ as $\bar{A} \cap (X \setminus A)$. Since both $\bar{A}$ and $X \setminus \text{int}(A)$ are closed, then their intersection is closed.
\end{document}
