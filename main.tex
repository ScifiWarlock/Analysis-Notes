...
We now define the notion of a topology, which is another way of classifying open and closed sets.
\begin{defn}
...
\medskip
\begin{defn}
A topology $\uptau$ for a space $X$ can be represented by a collection of subsets $\mathcal{B}$ called the basis:
\begin{enumerate}
    \item $\forall x \in X, \exists B \in \mathcal{B}: x \in B$
    \item $\forall x, \forall B_1, B_2 \in \mathcal{B}: x \in B_1 \cap B_2 \implies \exists B_3 \in \mathcal{B}: x \in B_3$
    \item $\forall A \subseteq X: A \ \text{open} \iff \forall x \in A, \exists B \in \mathcal{B}: x \in B$
\end{enumerate}
\end{defn}
For a metric space $(X, \varrho)$, the basis of the topology induced by the metric is the subcollection of all metric balls $B(x, r)$
