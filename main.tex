...
\end{lem}
\begin{proof}
We call the topology of unions $\uptau_B$. We assume that $\mathcal{B} \subseteq \uptau_B$. Then any arbitrary unions of basis elements belong in the topology. By part 2 of basis definition, it is also closed under arbitary intersections of $\mathcal{B}$. To show the two topologies are equivalent, we aim to show all open sets in $\uptau$ are unions of basis elements.\\

We know by the definition of $U \in \uptau$:
\begin{equation*}
    \forall x \in U, \exists B_x \in \mathcal{B}: x \in B_x \implies x \in \bigcup B_x \implies U \subseteq \bigcup B_x
\end{equation*}
